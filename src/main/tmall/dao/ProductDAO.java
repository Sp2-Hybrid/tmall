...
public class ProductDAO {
    ...
    public void setFirstProductImage(Product p) throws ClassNotFoundException {
    ...
    public void setSaleAndReviewNumber(Product p) throws ClassNotFoundException {
    ...
    public void setSaleAndReviewNumber(List<Product> products) throws ClassNotFoundException {
