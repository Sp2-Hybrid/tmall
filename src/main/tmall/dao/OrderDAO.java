...
public class OrderDAO {
    ...
    public List<Order> list(int uid, String excludedStatus) throws ClassNotFoundException {
        return list(uid,excludedStatus,0, Short.MAX_VALUE);
    }

    public List<Order> list(int uid, String excludedStatus, int start, int count) throws ClassNotFoundException {
        List<Order> beans = new ArrayList<Order>();
